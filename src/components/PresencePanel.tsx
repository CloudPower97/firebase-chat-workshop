  ...
  useEffect(() => {
    ...
    onValue(isConnectedRef, (snapshot) => {
      if (snapshot.val() === true) {
        onDisconnect(userStatusRef).set({ online: false, at: serverTimestamp(), name: `${me.name} ${me.surname}` });
        set(userStatusRef, { online: true, at: serverTimestamp(), name: `${me.name} ${me.surname}` });
      }
    });
